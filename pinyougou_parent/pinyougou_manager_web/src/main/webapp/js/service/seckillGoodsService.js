...
app.service('seckillGoodsService', function ($http) {
    ...
    //审核
    this.isCheck=function (ids) {
        return $http.post('../seckillGoods/isCheck.do?ids='+ids)
    };
    //审核不通过
    this.isNotCheck=function (ids) {
      return $http.get('../seckillGoods/isNotCheck.do?ids='+ids)
    };
    //获取SellerId
    this.getSellerId=function () {
        return $http.get('../seckillGoods/getSellerId.do')
    }
});
