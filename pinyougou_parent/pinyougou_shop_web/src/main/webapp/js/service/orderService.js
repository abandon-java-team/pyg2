...
app.service('orderService', function ($http) {
    ...
    //发货
    this.deliverGoods = function (orderIdStr) {
        return $http.get('../order/deliverGoods.do?orderIdStr='+orderIdStr)
    }

    //订单统计
    this.accountByGoods = function () {
        return $http.get('../order/accountByGoods.do');
    }
});
